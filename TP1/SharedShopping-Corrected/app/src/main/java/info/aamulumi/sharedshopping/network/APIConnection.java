package info.aamulumi.sharedshopping.network;
...
public abstract class APIConnection {
    ...
    /**
     * Send a request to add an new item to the shopping list
     *
     * @param slName - name of the shoppingList
     * @param name - name of the new item
     * @param quantity - quantity of the new item
     * @param price - price of the new item
     * @return the updated shopping list
     */
    public static ShoppingList createShoppingListItem(String slName, String name, String quantity,
                                                   String price) {
        ...
        return APIConnection.createItem(urlShoppingLists + "/" + slName, "parseShoppingList", null, params);
    }

    /**
     * Send a request to edit an item in the shopping list
     *
     * @param slName - name of the shoppingList
     ...
     * @return the updated shopping list
     */
    public static ShoppingList editShoppingListItem(String slName, String name, String quantity,
                                                   String price) {
        HashMap<String, String> params = new HashMap<>(3);
        params.put("name", name);
        if (quantity != null) params.put("quantity", quantity);
        ...
        return APIConnection.editItem(urlShoppingLists + "/" + slName, "parseShoppingList", null, params);
    }

    /**
     * Send a request to delete an item in the shopping list
     *
     * @param slName - name of the shoppingList
     * @param name - name of the item
     * @return the updated shopping list
     */
    public static boolean deleteShoppingListItem(String slName, String name) {
        HashMap<String, String> params = new HashMap<>(1);
        params.put("name", name);

        return APIConnection.deleteItem(urlShoppingLists + "/" + slName, null, params);
    }
